...
```{r, fig.cap = "Figure 1"}
knitr::include_graphics("images/three-toy-schematic.png")
```
...
```{r}
knitr::kable(glm_fit, caption = str_c("Figure ", caption_figure()))
```
