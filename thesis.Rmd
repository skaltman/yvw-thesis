...
[**from hyo: add something like:  prior work suggests both early emergence and variability. It starts early in life, but there is considerable variability across contexts and actions. Yet, we don't know WHY these variability exists -- try to convince readers that this variability may not be random but reveals something important that enables prosocial intent to manifest as actions**]
