...
Of the `r three_between_response$num_bb` out of `r summary_three_toy$num_bb` children in the Broken Button condition who targeted the toys on the tray, all targeted a bottom button. Thus, even though children changed the toy, they did not attribute the source of the confederate's failure solely to the toy itself, as they also changed the action taken on the toy. In contrast, none of the `r three_between_response$num_bt` in the Broken Toy condition who targeted the toys on the tray targeted a bottom button.
...
In contrast to Experiment 1, children showed no preference for either toy in the Broken Button condition. In both experiments, it is possible to fulfill the confederate's goal of playing music by helping at either toy. However, the specificity of the confederate's goal is actually unclear: does she just want to play music in general (the *general* goal), or does she want to play music with her chosen toy (the *specific* goal)? She does explicitly choose a toy, but, when she asks the child to "show her", she does not reiterate this preference. If she just wants to play music and has no toy preference, than helping at either toy is equally helpful. If she wants help with her chosen toy, then it more directly fulfills her goal to help her with that toy. However, because the toys are visually and functionally identical in this condition, it is also possible to show her how her own toy works by showing her how to operate the other toy.  

A likely explanation for children's behavior in this condition is that they are not distinguishing between the two toys in this condition. If they are not distinguishing between the two toys, they may then not interpret the confederate's actions as indicating a preference for one toy over another, which in turn would imply that she possesses the general goal and they can help her by targeting either toy. This is consistent with prior research suggesting that young toddlers view a repeated choice between two objects as a preference if the two objects belong to differnet global categories, but will not view a repeated choice between two identical objects as an expression of a side preference [@Spaepen2007].
...
In the Broken Toy condition, children still preferentially target the other toy, even though the toys are now visually distinct. If children are attributing a toy preference to the confederate, this indicates that children are willing to override the confederate's choice of toy if they realize that her choice is incompatible with her goal. [connect to paternalism article]

[talk about helpfulness]
...
- one year olds
- rates of helping for other papers versus our kids
