...
Thus, it is unclear what children thought the confederate's goal was in this experiment, as well as why children in the Broken Button condition demonstrated no preference for either toy. We designed a third experiment in which the confederate's goal was more explicitly to play music with her chosen toy.

what is the connection? in experiment 2 it's helpful to do things at either toy. so we can't really reason about what children are doing. in experiment 3, we have a directed prediction. the signal is clearer, can reason more clearly about what's going on. 


This eliminates several of the previously discussed reasons why children in Experiment 2 could reasonably target either toy in the Broken Button condition. If children preferentially target the confederate's toy in this new experiment, we would have a clearer idea of how they were thinking about the confederate's goal and what consistitues effective help. [FIX]
