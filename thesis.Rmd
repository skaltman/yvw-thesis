...
Here we investigate how 2- and 3-year-olds help others. Much of the helping literature has focused on if and when children help. However, helping can also be seen as a decision about how to help that depends on inferences about another person's goals and beliefs, as well why the likely reason behind that person's failure. In three experiments, we varied the likely source of a confederate's failure to investigate if children are able to recruit prior knowledge and causal reasoning skills in order to effectively target the source of the confederate's failure and thus effectively help her achieve a goal. In Experiment 1, children learned about a system of three toys that played music. There were two possible ways to fail to produce music with the toys, and children watched confederate failed in one such way and then request help. Children were then presented with two potential ways to help, one of which targeted the confederate's source of failure and one of which did not. Experiment 2 was a conceptual replication of Experiment 1. In Experiment 3, we altered the structure of the toys to make the confederate's goal more explicit. This allowed us to explore how children incorporated information about the confederate's goal into their helping behavior.
...
## When do children begin to help?
...
Therefore, young children are able to both attribute goals to agents and determine what type of actions are likely to indicate a goal. These skills are crucial in helping scenarios in which it is necessary to infer an agent's goal from their actions alone.  

## Reasoning about the beliefs of others

However, understanding another a goal from observing someone's actions alone is often not sufficient in order to help effectively. In many scenarios, helping requires reasoning about the beliefs of others. Informing scenarios, as discusses earlier, always involve taking into account the information that you possess that your social partner lacks. 
