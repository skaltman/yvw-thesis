...
modified_tidy %>% 
  filter(n != 110, n != 109) %>% 
  count(condition, flip) 

# broken toy: 2/36: 5%
# wrong action: 25/36: 70%
```
...
modified_tidy %>% 
  ...
  modified_tidy %>% 
  filter(videoName == "YVW_170912_01")
```
