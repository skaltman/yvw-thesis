...
![Figure `r caption_figure()`](images/three-toy-schematic.png)
...
The experimenter took the first toy out of the basket, remarked that it had a blue button on the top, and pushed the button. When the button played music, she reacted positively, saying, "Music! It plays music!" She asked the child if s/he would like to try and encouraged the child to push the same button. When the toy played music, the confederate remarked again, "Music! It plays music! This side plays music." The confederate then turned the toy around until she discovered the button on the bottom of the toy. She expressed mild surprise upon finding a button on the bottom of the toy. She pressed the button. In the Broken Toy condition, this button played music, and the confederate responded in exactly the same way as she did when the top button played music. In the Broken Button condition, however, the bottom button did not play music. The confederate remarked, "Nothing! No music," shaking her head as she spoke. After the child 
...
We recruited `r summary_modified$num_participants` 24- to 48-month-old participants (M(SD) = `r summary_modified$mean_age`(`r summary_modified$sd_age`), %% female). `r summary_modified$num_jmz` of these participants (M(SD) = `r summary_modified$mean_age_jmz`(`r summary_modified$sd_jmz`)) were recruited from a museum in Palo Alto, CA. `r num_bing` of these participants (M(SD) = `r summary_modified$mean_age_bing`(`r summary_modified$sd_bing`)) were recruited from a local preschool. An additional `r num_excluded$total` children were excluded from analysis due to experimenter error (n = `r num_excluded$experimenter`), parental or sibling interference (n = `r num_excluded$parent + num_excluded$sibling`), the child responding too early (n = `r num_excluded$early`), the child having prior exposure to the experiment (n = `r num_excluded$already_played`), or lack of video recording (n = `r num_excluded$no_video`).
