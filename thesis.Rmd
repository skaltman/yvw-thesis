...
Furthermore, although some (`r three_between_response$num_bb` / `r summary_three_toy$num_bb`) children in the Broken Button condition targeted the toys on the tray, 
