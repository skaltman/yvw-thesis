...
Children start to understand goal-directed actions at a very young age. At 9 months, children can distinguish between situations in which an adult does not want to give them a toy and situations in which she is unable to do so (Behne, Carpenter, Call, & Tomasello, 2005). Luo and Baillargeon (2005) found that 5-month-olds expect inanimate objects to continue choosing to move towards objects that they have chosen in the past. 
Furthermore, 6.5-month-olds who watched inanimate objects repeatedly move around obstacles to reach a destination expected those objects to move efficeintly toward the destinate once the obstacles were removed, sugggesting both that they understand motion as goal-directed and that they expect agents to achieve goals efficiently (Csibra, 2008). 
By 18-months, children can infer the intentions of others even from incomplete actions (Meltzoff, 1995). This skill is particularly crucial when helping others, as people in need of help typically fall short of their intended action, and it is thus necessary to infer a goal without witnessing the person accomplish that goal first. 
