...
Children start to understand goal-directed actions at a very young age. Children as young as five months will view an adult's repeated reach for one type of object over another as goal-directed, and expect that adult to continue reaching for that type of object (Woodward, 1998). 


At 5 months, children expect inanimate objects to continue moving towards objects that they have moved towards in the past (Luo & Baillargeon, 2005). They also 


- 6.5-month-olds who watched inanimate objects repeatedly move around obstacles to reach a destination expected those objects to move efficeintly toward the destinate once the obstacles were removed, sugggesting both that they understand motion as goal-directed and that they expect agents to achieve goals efficiently (Csibra, 2008). 


-At 9 months, children can distinguish between situations in which an adult does not want to give them a toy and situations in which she is unable to do so (Behne, Carpenter, Call, & Tomasello, 2005). 
